...
const VerifyEnvironment = Schema.Struct({
...
const config = Schema.decodeUnknownSync(VerifyEnvironment)({
  port: process.env.XKEEP_VERIFY_PORT,
  dataDir: process.env.XKEEP_VERIFY_DATA_DIR,
})
