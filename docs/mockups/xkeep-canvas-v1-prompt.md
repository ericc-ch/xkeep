# xkeep canvas mockup v1 prompt

Use case: ui-mockup

Asset type: high-fidelity desktop product design baseline for xkeep, a local X bookmarks canvas app

Primary request: Create one polished 16:10 desktop application screenshot showing the approved xkeep interface. It must look buildable as a Solid + Pixi web app, not like concept art and not like a marketing website.

Scene/backdrop: Full-window infinite cool-gray canvas with a very subtle dot grid. Hundreds of small bookmark cards are distributed in organic semantic neighborhoods with plenty of negative space; related cards sit near one another. All cards remain readable and roughly consistent in screen size, even across the large zoomed-out canvas. Some overlap is acceptable. An always-visible compact minimap sits in the lower-left corner.

Subject: Figma-like canvas UI. A compact floating top bar centered near the top contains the exact search text "Search the canvas", a "Filters" button, a "Tags" overlay button, and a "Clusters" overlay button. A small xkeep wordmark and menu sit top-left. A compact status pill near bottom center reads "2,418 ready · 36 embedding". Zoom controls and "Fit" sit near the minimap.
...
Lighting/mood: flat interface lighting, calm, technical, focused, quietly premium.

Text (verbatim): "xkeep"; "Search the canvas"; "Filters"; "Tags"; "Clusters"; "Bookmark"; "Maya Chen"; "@mayacodes"; "A visual explanation of vector databases that finally clicked for me."; "research"; "databases"; "Open on X"; "Delete"; "2,418 ready · 36 embedding"; "Fit".
